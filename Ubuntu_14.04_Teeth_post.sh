...
sed -i 's/GRUB_CMDLINE_LINUX_DEFAULT.*/GRUB_CMDLINE_LINUX_DEFAULT="rd.fstab=no acpi=noirq noapic biosdevname=0 net.ifnames=0 cgroup_enable=memory swapaccount=1 quiet"/g' /etc/default/grub
